...
Этот проект основан на [fuwari](https://github.com/saicaca/fuwari) для модификации/обучения. Авторские права принадлежат оригинальному правообладателю.
Распространяется под лицензией [MIT license](https://mit-license.org/), подробности см. в файле [LICENSE](../LICENSE).
