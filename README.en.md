...
This project is based on [fuwari](https://github.com/saicaca/fuwari) for modification/learning. Original copyright belongs to the original author.
Licensed under the [MIT license](https://mit-license.org/). See the [LICENSE](./LICENSE) file for details.
